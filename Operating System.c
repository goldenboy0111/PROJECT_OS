...
void menu()
{
	while (true)
	{
		...
		{
		case 0:
			printf("1-) Scheduling Method (None :None of scheduling methode chosen)\n");
			break;
		case 1:
			printf("1-) Scheduling Method (First Come,Served Scheduling)\n");
			break;
		case 2:
			printf("1-) Scheduling Method (Shortest-Job-First Scheduling)\n");
			break;
		case 3:
			printf("1-) Scheduling Method (Priority Scheduling)\n");
			break;
		case 4:
			printf("1-) Scheduling Method (Round-Robin Scheduling)\n");
			break;
		default:
